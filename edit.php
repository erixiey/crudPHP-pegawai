...
<body>
    ...
    <div class="container">
        <div class="text-center mb-4">
            ...
            <p class="text-muted">Klik perbarui setelah mengganti informasi</p>
        </div>
        ...
        <div class="container d-flex justify-content-center">
            <form action="" method="post" style="width:50vw; min-width:300px;">
                ...
                <div class="form-group mb-3">
                    <label>Kelamin:</label> &nbsp;
                    <input type="radio" class="form-check-input" name="gender" id="Pria" value="Pria" <?php echo ($row["gender"] == 'Pria') ? "checked" : ""; ?> >
                    <label for="Pria" class="form-input-label" >Pria</label>
                    &nbsp;
                    <input type="radio" class="form-check-input" name="gender" id="Wanita" value="Wanita" <?php echo ($row["gender"] == 'Wanita') ? "checked" : ""; ?> >
